...
echo -e "\e[1;31m$(cat maclog)\e[0m"
echo ""
echo -e "\033[33m[*] ¡Cambia tu direccion MAC para una auditoria mas segura! \033[0m"
echo ""
echo -e "\033[31m[-] Menu de opciones: \033[0m"
echo ""
echo "[0] Mostrar informacion de la MAC actual"
echo "[1] Resetear a la direccion MAC original"
echo "[2] Asignar una MAC aleatoria del mismo fabricante"
echo "[3] Cambiar a una MAC random"
echo "[4] Ver la lista de fabricantes soportados por macchanger"
echo "[5] Utilizar una MAC personalizada"
echo "[6] Salir"
echo ""
...
case $optmac in
	...
	0)
                echo ""
                echo -e "\033[31m[-] Informacion de la MAC actual: \033[0m"
                echo ""
